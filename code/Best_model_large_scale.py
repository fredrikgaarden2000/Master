            ...
            for c in capacity_levels:
                ...
                if not alt["EEG_flag"]:
                    if alt["category"] == "CHP_nonEEG":
                        rev = N_CH4_max * (alphaHV / 1000) * (chp_elec_eff * electricity_spot_price + chp_heat_eff * heat_price)
                    ...
                    if alt["category"] in ["EEG_CHP_small", "EEG_CHP_large"]:
                        ...
                        rev = (EEG_rev + spot_rev + heat_rev + bonus) 
                    else:
                        rev = 0
                ...
                if alt["opex_type"] == "fixed_variable_MW":
                    ...
                    cost = fixed_opex + variable_opex / 1e6
                else:
                ...
                print(f"  M_rev[{j}, {a}, {c}] = {M_rev[key]:,.6f} €")
                print(f"  M_cost[{j}, {a}, {c}] = {M_cost[key]:,.6f} €")
